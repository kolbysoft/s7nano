...
{
  s7_pointer cur_env;
  s7_pointer pcl_s, pl_sx, pl_st, pl_si, pl_sis, pl_ssi, pl_sisi, pl_sssi, pl_ssix, pcl_di, pl_ds, pcl_x, pl_xs, pcl_xi, pl_xi, pl_xt, pcl_xs, pl_xxi, pcl_xxi, pcl_xsi, pl_xis, pl_xxxi, pl_xssx, pcl_t, pl_tx, pl_ts, pl_ti, pl_txs, pl_iixiixi, pcl_i, pl_ix, pl_it, pcl_is, pl_is, pcl_ix, pcl_iix, pcl_isi, pl_ixi, pl_isi, pcl_ixi, pl_iix, pl_isx, pl_isxi, pl_iisi, pcl_iixi, pl_iixi, pl_issi, pl_ixxi, pcl_ixsi, pl_iiixi, pl_ixiix;
  {
